...
export class DatatargetLog1726585521817 implements MigrationInterface {
    name = 'DatatargetLog1726585521817'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_1d333574ef086bee54ff78b2e0"`);
