...
export class KombitUserManagement1643632678086 implements MigrationInterface {
    name = 'KombitUserManagement1643632678086'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user_requested_organizations_organization" ADD CONSTRAINT "FK_87ad1ad67570c6ca20f62c95313" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "user_requested_organizations_organization" ADD CONSTRAINT "FK_6a0a3602e88b71bc867af425d89" FOREIGN KEY ("organizationId") REFERENCES "organization"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "IDX_6a0a3602e88b71bc867af425d8"`);
        await queryRunner.query(`DROP INDEX "IDX_87ad1ad67570c6ca20f62c9531"`);
