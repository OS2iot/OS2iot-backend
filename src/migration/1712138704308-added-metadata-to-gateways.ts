...
export class AddedMetadataToGateways1712138704308 implements MigrationInterface {
    name = 'AddedMetadataToGateways1712138704308'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."gateway_status_enum" AS ENUM('IN-USE', 'PROJECT', 'PROTOTYPE', 'OTHER')`);
